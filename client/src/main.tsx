...
const isDiagramFixtureVariant = (value: string | null): value is DiagramFixtureVariant => value === "svg" || value === "source" || value === "sourceGraph" || value === "thermoregulation" || value === "fermentation" || value === "variation" || value === "beak" || value === "vertebra" || value === "broken" || value === "wide" || value === "portrait" || value === "none";
