...
const isDiagramFixtureVariant = (value: string | null): value is DiagramFixtureVariant => value === "svg" || value === "source" || value === "sourceGraph" || value === "wide" || value === "portrait" || value === "none";
