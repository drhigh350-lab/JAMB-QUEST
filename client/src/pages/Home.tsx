...
import { OwnerDiagramAudit } from "@/components/OwnerDiagramAudit";
...
interface HomeProps {
  ...
  activeQuestions?: import("@/game/types").BankQuestion[]; challengeQuestions?: import("@/game/types").BankQuestion[];
  ...
  return <main className={`home-page tabbed-home compact-home ${entranceReady ? "entrance-ready" : ""}`}>
    ...
    <div key={`content-${activeTab}`} className="tab-content page-shell tab-cinematic-entry tab-cinematic-content">
      ...
      {activeTab === "profile" && <>
        ...
        <OwnerDiagramAudit isOwner={isOwner} />
