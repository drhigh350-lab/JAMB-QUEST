...
type ReminderState = { enabled: boolean; reminderTime: string; pushEnabled: boolean; providerQueue?: { scheduledCount: number; nextScheduledAt: Date | null; horizonDays: number } };
