    ...
    <div key={`content-${activeTab}`} className="tab-content page-shell tab-cinematic-entry tab-cinematic-content">
      {activeTab === "practice" && <>
        ...
        <section className="compact-action-grid tab-section entrance-item entrance-tools" aria-label="Practice tools">
          ...
          <CompactPanel eyebrow="02 / PRACTICE" title="Choose your practice path" note={isLekkiPalette ? "Lekki novel · choose 10, 20, 40, or 50 questions" : "Single Subject for focused repair, or Standard CBT for a full two-hour simulation"} tone="paper">
          ...
          <CompactPanel eyebrow="03 / OFFICIAL SYLLABUS" title="Choose from the JAMB syllabus" note="Use this when you want a deliberate revision path: choose one official section, then one exact topic or a broad section drill." tone="maize">
            <div className="syllabus-use-guide"><span><b>1</b> Pick a subject above</span><span><b>2</b> Open an official syllabus section</span><span><b>3</b> Start one topic or the whole section</span></div>
      ...
      {activeTab === "progress" && <>
        <section className="compact-progress-grid tab-section" aria-label="Progress tools">
          <CompactPanel eyebrow="01 / NEXT MOVE" title={balancedCoreFocus ? `Strengthen ${balancedCoreFocus.subject}` : "Create your first evidence"} note={progressNextAction} tone="maize">
          ...
          <CompactPanel eyebrow="04 / REVISION RETURNS" title="Bring a topic back at the right time" note="Optional device-only question returns from Syllabus Journey" tone="paper">
            <RevisionReturnQueue onStart={onStart} />
          </CompactPanel>
          <CompactPanel eyebrow="05 / FINAL DAY" title="Your final-day review" note="Review evidence, protect confidence, and avoid random cramming" tone="maize">
