...
import { ArrowRight, Atom, Award, BellOff, BellRing, BookmarkCheck, BookOpen, CalendarCheck2, CheckCircle2, CircleHelp, CircleUserRound, Clock3, Download, Flame, FlaskConical, Leaf, ListChecks, LogIn, Medal, RotateCcw, Send, Share2, ShieldCheck, Sparkles, Target, Trophy, Wifi, WifiOff, Zap } from "lucide-react";
        ...
        <section className="compact-action-grid tab-section entrance-item entrance-tools" aria-label="Practice tools">
          ...
          <CompactPanel eyebrow="02 / PRACTICE" title="Choose your practice path" note={isLekkiPalette ? "Lekki novel · choose 10, 20, 40, or 50 questions" : "Single Subject for focused repair, or Standard CBT for a full two-hour simulation"} defaultOpen tone="paper">
            <div className="practice-route-grid" aria-label="Practice paths">
              ...
              <button data-testid="quest-rush-path" className="practice-route quest-rush-route" onClick={() => setQuestRushOpen(true)} disabled={loading || !!loadError || activeQuestions.length < 4}><Zap size={18} /><span><b>Quest Rush</b><small>12 questions · 75-second game burst</small></span><ArrowRight size={15} /></button>
            </div>
