...
export default function Home({ loading, loadError, progress, canReview, onRetryLoad, onStart, auth, questionCount, questionCountReady, comeback, reminder, achievementStats, examHistory, onOpenExamLog = () => undefined, examReviewOpening = false, examReviewError = null, weakTopics, topicConfidence = [], subjectPerformance = [], fullMockSubjectPerformance = [], coreSubjectFocus = null, availableTopics = [], bookmarks = [], comparison, onUpdateDailyMinimum, onUpdateDailyGoal = () => undefined, onEnablePush, onDisablePush, onTestPush = () => undefined, pushWorking, pushStatus, pwa, resumableCbt = null, onResumeCbt = () => undefined, onDiscardResumableCbt = () => undefined }: HomeProps) {
  ...
  return <main className={`home-page tabbed-home compact-home ${entranceReady ? "entrance-ready" : ""}`}>
    <Dialog open={fullMockSetupOpen} onOpenChange={setFullMockSetupOpen}>
      <DialogContent className="jamb-cbt-setup-dialog">
        ...
        <div className="cbt-ready-list">
          <span><Clock3 size={15} /> 2-hour countdown</span><span><ListChecks size={15} /> Question palette and flags</span><span><Target size={15} /> JAMB calculator available in CBT</span>
        </div>
