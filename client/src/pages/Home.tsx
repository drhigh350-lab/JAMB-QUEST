    ...
    <div key={`content-${activeTab}`} className="tab-content page-shell tab-cinematic-entry tab-cinematic-content">
      {activeTab === "practice" && <>
        ...
        <section className="compact-action-grid tab-section entrance-item entrance-tools" aria-label="Practice tools">
          ...
          <CompactPanel eyebrow="03 / OFFICIAL SYLLABUS" title="Choose from the JAMB syllabus" note="Use this when you want a deliberate revision path: choose one official section, then one exact topic or a broad section drill." defaultOpen={desktopDesk} tone="maize">
