...
function App() {
  ...
  const ownerHeldDiagramRecordsQuery = trpc.qualityReview.heldDiagramRecords.useQuery(undefined, { enabled: user?.role === "admin", retry: false });
