...
describe("Concise Practice route placement", () => {
  it("keeps Standard CBT first and places Topic Drill, Syllabus Journey, and Arcade as separate tools inside Practice", () => {
    ...
    expect(home).toContain('type AppTab = "practice" | "progress" | "profile" | "about"');
    ...
    expect(styles).toContain(".app-tabbar{grid-template-columns:repeat(4,1fr)");
