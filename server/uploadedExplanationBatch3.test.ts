...
describe("uploaded explanation batches 2 and 3", () => {
  it("uses the managed combined explanation asset and invalidates stale offline packs", () => {
    ...
    expect(QUESTION_BANK_URL).toContain("jamb_high_yield_practice_bank_1000_explanations_batches2_3_v1_fd2d09f2.json");
    expect(offlinePack).toContain("jamb-quest-study-pack-v4");
    expect(worker).toContain("jamb-quest-study-pack-v4");
  });
