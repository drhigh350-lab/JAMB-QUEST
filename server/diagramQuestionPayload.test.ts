...
describe("instructional diagram question payload", () => {
  ...
  it("keeps a fixture-only route for every audited diagram shape and the no-diagram fallback", () => {
    ...
    expect(fixture).toContain("biology-0502-testdriller-original_eea7904a.png");
    expect(fixture).toContain("biology-0523-testdriller-original_f9b78c24.png");
    expect(fixture).toContain("biology-0527-testdriller-original_8ece4a3c.png");
    expect(fixture).toContain("biology-0890-testdriller-original_300cb4b6.png");
    expect(fixture).toContain("biology-1041-testdriller-original_f360a5e8.png");
    expect(fixture).toContain("biology-1033-testdriller-original_425154e0.png");
    expect(fixture).toContain("boundary-x0-520-y38-354_5d0f5769.png");
