...
const subject = process.argv[2] as "Biology" | "Chemistry" | "Physics";
const batch = Number(process.argv[3] ?? 1);
if (!subject || !["Biology", "Chemistry", "Physics"].includes(subject)) throw new Error("Subject must be Biology, Chemistry, or Physics");
