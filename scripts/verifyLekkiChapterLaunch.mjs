...
try {
  ...
  if (!String(chapterConfig.topic ?? "").startsWith("The Lekki Headmaster · Chapter") || chapterConfig.count !== 20) throw new Error(`Lekki chapter selection did not launch an exact chapter drill: ${JSON.stringify(chapterConfig)}`);
