...
const reportPath = path.join(projectRoot, "reports", "recovered_biology_0518_diagram_release_20260825.json");
const target = {
  externalId: "biology_0518",
  expectedCurrentDiagramUrl: null,
  replacementDiagramUrl: "/manus-storage/biology-0518-myschool-original_32575fb8.png",
  questionText: "Use the diagram above to answer this question. The animal represented by I is a",
  optionsJson: '["poikilotherm","homoiotherm","carnivore","herbivore"]',
  answerIndex: 1,
...
try {
  ...
  if (!sourceMatches) {
    ...
    receipt.reason = "already mapped to verified original thermoregulation graph";
    ...
    if (result.affectedRows !== 1) {
      ...
      receipt.reason = "exact MySchool original thermoregulation graph verified separately from the source answer and free of watermark, answer text, and source chrome";
    }
  }
