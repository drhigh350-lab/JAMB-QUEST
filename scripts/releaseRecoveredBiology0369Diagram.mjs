...
const reportPath = path.join(projectRoot, "reports", "recovered_biology_0369_diagram_release_20260825.json");
const target = {
  externalId: "biology_0369",
  expectedCurrentDiagramUrl: null,
  replacementDiagramUrl: "/manus-storage/biology-0369-schoolngr-source-panel_aa1ec92c.png",
  questionText: "From the diagram above, The bile is stored in the part labelled",
...
try {
  ...
  if (!sourceMatches) {
    ...
    if (result.affectedRows !== 1) {
      ...
      receipt.reason = "exact public-source original figure cropped without options, answer text, or source chrome";
    }
  }
