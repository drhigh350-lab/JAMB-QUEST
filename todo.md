...
- [ ] Audit all learner-playable diagram questions, document the random/exact question-selection rules for Practice and CBT, and inspect MySchool’s public JAMB question flow for lawful, non-copying coverage and usability improvements. Turn verified loopholes from the learner’s voice review into individually tested JAMB Quest fixes.
