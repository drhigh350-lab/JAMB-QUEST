...
- [ ] Integrate only eligible batch-eight Physics explanations into the unified model-bank asset without altering protected question fields. **Held:** all 100 supplied entries include the prohibited generic template ending, so none has been released.
