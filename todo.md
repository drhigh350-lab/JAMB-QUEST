...
- [ ] Resolve the 17 remaining diagram holds only where retained history provides sufficient internally consistent geometry and label mapping; do not release the conflicting cell pair, missing organic structures, missing graph geometry, or missing vectors with a misleading substitute.
