...
- [ ] Audit every non-Lekki core-subject active question outside the short-explanation CSV—Use of English, Biology, Chemistry, and Physics—for missing instructions or context, answer gaps, malformed learner-facing text, and scientific notation that should render with Unicode superscripts; apply only evidence-supported repairs and hold incomplete context rather than inventing it.
