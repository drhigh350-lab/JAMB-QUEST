...
- [ ] Audit all non-Lekki active questions outside the short-explanation CSV for missing English instructions and answer gaps, malformed learner-facing text, and scientific notation that should render with Unicode superscripts; apply only evidence-supported repairs and hold incomplete context rather than inventing it.
