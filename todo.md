...
- [ ] Replace the failed runtime scheduler with a provider-scheduled OneSignal queue: pre-create the learner’s upcoming 7:00 a.m., 1:00 p.m., and 7:00 p.m. Africa/Lagos messages, persist message IDs and window keys, prevent duplicates, and expose queue health plus a safe refresh action in Profile.
