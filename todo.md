...
- [ ] Resolve the final 8 remaining diagram holds only where retained history provides sufficient internally consistent geometry and label mapping. An additional 9 records have now been source-recovered and restored; do not release the remaining missing graph, organic-structure, or ambiguous label records with a misleading substitute.
